...
INSERT INTO forfait (nom, prix, description, duree) VALUES ('Winnie', 10, 'Le plus petit forfait. Vous avez droit que au gym de base', 1);
INSERT INTO forfait (nom, prix, description, duree) VALUES ('Ariel', 15, 'Accès au gym de base et à la piscine.', 6);
INSERT INTO forfait (nom, prix, description, duree) VALUES ('Prince Charment', 20, 'Accès à tout que les jours de la semaine.', 12);
INSERT INTO forfait (nom, prix, description, duree) VALUES ('Hercule', 24, 'Notre plus gros forfait, acces à presque tout', 12);
