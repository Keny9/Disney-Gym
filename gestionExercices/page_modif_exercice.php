<!DOCTYPE html>
<!-- /****************************************
Fichier : page_modif_exercice.php
Auteur : William Gonin
Fonctionnalité : Fichier pour afficher la page modifier exercice
Date : 2019-04-28
...
<html lang="fr" dir="ltr">
  ...
  <?php
  $nomPage = "Modification d'Exercice";
  require_once 'exercice.php';
  require_once 'gestionExercices.php';
  $ge = new GestionExercices();
  $exercice = $ge->getExercice($_POST['idExercice']);
  $oldId = $_POST['idExercice'];
  ?>
  <body>
    <div class="contenu">
      ...
      <main class="gestion_employe col-m-12">
        ...
        <form class="formulaire_employe" id="formulaire" method="post">
            ...
            <div class="">
              <label class="col-m-5 col-t-3" for="id">Id</label>
              <input type="text" name="id" id="id" value="<?php echo $oldId; ?>" disabled>
              <span class="erreur" id="erreurIdentifiant"></span>
            </div>

            <div class="">
              <label class="col-m-5 col-t-3" for="nom">Nom</label>
              <input type="text" name="nom" id="nom" value="<?php echo $exercice->getNom(); ?>">
            ...
            <div class="">
              ...
              <input type="text" name="description" id="description" value="<?php echo $exercice->getDescription(); ?>">
            ...
            <div class="">
              <label class="col-m-5 col-t-3" for="image">Image</label>
              <img id="image" src="<?php echo $exercice->getImage(); ?>" alt="Image">
              <span class="erreur" id="erreurPassword"></span>
            </div>

            <div class="">
              <label class="col-m-5 col-t-3" for="type">Type</label>
              <input type="text" name="type" id="id_type" value="<?php echo $exercice->getId_type(); ?>">
          ...
          <div class=" col-m-12">
            <div class="conteneur_bouton col-m-12 col-t-6">
              <input class="btn btn-success" type="button" onclick="modif('<?php echo $oldId ?>')" value="Confirmer" id="btn_confirmer">
            </div>
            <div class="conteneur_bouton col-m-12 col-t-6">
